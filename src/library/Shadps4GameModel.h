...
class Shadps4GameModel final : public QAbstractListModel {
  Q_OBJECT
  Q_PROPERTY(bool shadps4Detected READ shadps4Detected NOTIFY statusChanged)
...
public:
  ...
  [[nodiscard]] bool shadps4Detected() const;
...
private:
  ...
  void applyScan(const Shadps4ScanResult& result);
